      ...
      <div class="row">
        ...
        <ul class="text-center"> 
          <li >
            ...
            <span class="col-sm-4 col-xs-6 title">时间</span>
            <span class="col-sm-2 col-sx-3 title">交易数</span>
            <span class="col-sm-2 pc title">手续费</span>
            <span class="col-sm-2 pc title">数据大小</span>
          </li>
          <li v-for="item in blockList" style="line-height: 30px;">
            ...
            <span class="col-sm-2 col-xs-3" @click="toBlockDetail(item.height)">{{ item.height }}</span>
            <span class="col-sm-4 col-xs-6">{{ item.timestamp }}</span>
            <span class="col-sm-2 col-xs-3">{{ item.txnum }}</span>
            <span class="col-sm-2 pc">{{ item.fee }}</span>
            <span class="col-sm-2 pc">{{ item.size }}</span> 
          </li>
        </ul>
        </span>
