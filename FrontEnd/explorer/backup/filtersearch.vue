...
<!--     <span class="filter-cakey-key filter-margin-top col-sm-6" style="color:white;">Select the NameSpace:</span>
    ...
    <div class="col-sm-11">
    	<span class="col-sm-4 ">
    		<span class="filter-appid-key filter-margin-top col-sm-5 " style="color:white;">区块高度:</span>
    		<span class="filter-appid-value filter-margin-top col-sm-7"><input v-model="key" style="border-radius: 5px;outline: none;width: 100%;"></span>
    	</span>
    	<span class="col-sm-4">
    		<span class="filter-appid-key filter-margin-top col-sm-5" style="color:white;">地址:</span>
    		<span class="filter-appid-value filter-margin-top col-sm-7"><input v-model="key" style="border-radius: 5px;outline: none;width: 100%;"></span>
    	</span>
    	<span class="col-sm-4">
    		<span class="filter-appid-key filter-margin-top col-sm-5" style="color:white;">交易编号:</span>
    		<span class="filter-appid-value filter-margin-top col-sm-7"><input v-model="key" style="border-radius: 5px;outline: none; width: 100%;"></span>
    	</span>
    </div>
    ...
    <div class="col-sm-11" style="margin-top: 10px;">
    	<span class="col-sm-4 ">
    		<span class="filter-appid-key filter-margin-top col-sm-5 " style="color:white;">开始时间:</span>
    		<span class="filter-time-start filter-margin-top col-sm-7" style="color:white;"><input v-model="value" class="starttime" name="" id="date" value=""   style="border-radius: 5px;outline: none;color:black;" placeholder="例：2017-01-01"/></span>
    	</span>
    	<span class="col-sm-4">
    		<span class="filter-appid-key filter-margin-top col-sm-5 " style="color:white;">结束时间:</span>
    		<span class="filter-time-start filter-margin-top col-sm-7" style="color:white;"><input v-model="value2" class="endtime" name="" id="date" value="" @change="getDate"   style="color:black;border-radius: 5px;outline: none;" placeholder="例：2017-01-10"/></span>
    	</span>
    </div>
    <!--修改：
    	<div class="col-sm-11">
